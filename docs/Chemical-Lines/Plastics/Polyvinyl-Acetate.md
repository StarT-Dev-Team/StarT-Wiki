...
![VinylAcetate_LCR](PVA_img/large_chemical_reactor_vinyl_acetate.png)
...
!!! example ""
    ...
    === "Air"
        ...
        ![PVA_Air](PVA_img/large_chemical_reactor_pva_from_air.png)

    === "Oxygen"

        ![PVA_Oxygen](PVA_img/large_chemical_reactor_pva_from_oxygen.png)

## Uses of PVA

As mentioned before, the main use of PVA is to make [PVB](/StarT-Wiki/Chemical-Lines/Plastics/Polyvinyl-Butyral).

![PVA_in_PVB](PVB_img/large_chemical_reactor_polyvinyl_butyral.png)