...
This is the best recipe for making Hydrofluoric Acid. While Hydrogen is abundant (mainly via the [Formic Acid](StarT-Wiki/Chemical-Lines/Acids/Formic-Acid) loop), Fluorine is more difficult to obtain. Methods of obtaining Fluorine include electrolysis of Topaz (Rock Filtrator or Mystical Agriculture), Lepidolite (Void Extractor processing), or Biotite (Deepslate processing).
